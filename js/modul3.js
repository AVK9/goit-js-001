...
//   let totalSalary = 0;
//   // Change code below this line
//      const massSalary = Object.values(salaries);
//      for (const key of massSalary) {
...
//   // Change code below this line
//      const obj = { completed, category, priority };
//      return {...obj, ...data};
//   // Change code above this line
// }
...
Після виклику методу bookShelf.updateBook("The last kingdom", "Dune"), значення властивості books - це масив ["Dune", "Haze", "The guardian of dreams"]
  !Проверь перввий визов влияет на 2-й  это по моему не правильно!*/
//  const bookShelf = {
//   books: ["The last kingdom", "Haze", "The guardian of dreams"],
//      updateBook(oldName, newName) {
//          // Change code below this line
//        const mass = [...this.books];
//          mass.splice(mass.indexOf(oldName), 1, newName);
//          return mass;

        //  this.books.splice(bookShelf.books.indexOf(oldName), 1, newName);
        //  return this.books;
    // Change code above this line
//    },
// };
...
const atTheOldToad = {
  ...
  updatePotionName(oldName, newName) {
    ...
    const klient = {...mass[potionIndex]};
    klient.name = newName;
    mass.splice(potionIndex, 1, klient);
    if (potionIndex === -1) {
      return `Potion ${oldName} is not in inventory!`;
    }
    this.potions = mass;
...
console.log(atTheOldToad.removePotion("Speed_potion"));
///////////////////////////////////////////////////////////
console.log(atTheOldToad.updatePotionName("Dragon breath", "Polymorth"));
console.log(atTheOldToad.updatePotionName("Stone skin", "Invulnerability potion"));
console.log(atTheOldToad.updatePotionName("Stone_skin", "Invulnerability potion"));
///////////////////////////////////////////////////////////
