...
//     return this.items.splice(idxToRemove, 1);
//   };
// }
...
//  }
/// Другие варианти записей!!!!!!!!!!!!!!!!!!!!!!
// В домашці можна написати методи порізному, що краще відпрацює?
...
// const audi = new Cara({ price: 35000 });
...
// const audi = new Cars({ price: 36000 });
// const bmw = new Cars({ price: 64000 });

// console.log(Cars.checkPrice(audi.price)); // "Success! Price is within acceptable limits"
// console.log(Cars.checkPrice(bmw.price)); // "Error! Price exceeds the maximum"


/////////////////////////////////////////////////////////////////
/*Блок 5 Завдання  18/20
  |============================
/*
